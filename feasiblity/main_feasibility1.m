% try to reduce computation time needed
cvx_setup;
...
R_thresholds = [1.5,2:0.25:6,6.5,7]; 
...
%             Feasibility_mulp = Feasibility_mulp;
    ...
    Feasibility_RS(i_SNR,i_th) = Feasibility_rs;
    ...
    Feasibility_MULP(i_SNR,i_th) = Feasibility_mulp;
end     % for i_th
end     % for i_SNR
save('Feasibilities_EqualWeight_31May', 'R_thresholds','Feasibility_RS','Feasibility_MULP');
